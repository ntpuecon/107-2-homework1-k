...
Ans:   ~I PREFER MY 2.2 ANS NOW lol~ BUT STILL DIDN'T HAVE MY BEST ONE STRUGLE STRUGLE
      $個經PR_i=經原不及格成績_i+(經原及格成績_i-經原不及格成績_i)可修個體$ #參考資料後的想法
...
Ans:
  ...
  !!!! different with chengcheng's !!!!  DISCUSS DISCUSS                
...
說明：學生的個經PR有很大的可能會受到經原PR影響,而經原PR又可能受學生的天資與後天努力所影響，因此控制經原PR為一個確保至少有相近立足點的概念。
...
&=\frac{\sum_{i,x_i=1}y_i-n\bar{x}\bar{y}}{n_1-\bar{x}^2}
&=\frac{\sum_{i,x_i=1}y_i}{n_1n_0/n}-\frac{n\bar{x}\bar{y}}{n_1n_0/n} \\
&=\frac{n\sum_{i,x_i=1}y_i}{n_1n_0}-\frac{n}{n_0}\bar{y}
