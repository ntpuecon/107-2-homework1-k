...
#          type = "html",
#          align = TRUE)
#↑↑我這串stargazer好像跑不出來，你能幫我確認下嗎？如果你也knit1不出來就直接刪掉，感恩
...
* 可修個經的學生若不可修個經，其個經PR應與原本就不可修個經的學生相同（需在同一個立足點才能做比較，即假設兩種人的"學習能力相同"）。
...
* 同上題，在進行迴歸估計時，除了變數的選擇，我們亦需要將立足點考慮進去。我們認為可修個體是否會影響到個經PR，但必須控制在立足點相同的前提之下。若我們在進行估計時，將有相同背景（經原PR相同，我們會認為學習能力可能差不多）的人控制住，即可用"可修個體"與否來探討擋修制度對個經PR的影響，專心探討我們真正在意的變數（"可修個體"對"個經PR"的解釋力）。
