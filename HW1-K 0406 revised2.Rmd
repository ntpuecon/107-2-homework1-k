...
<說明>
  ...
  若欲探討擋修制度對學生後續學習效果是否帶來正面的影響，單憑可修個體對個經PR跑回歸，可能會有偏誤。\
  
  首先，可修個體者（通過經原，微積分不為0分），我們可能會認為其學習能力較強，理應會有較高的個經PR。
  但若一名學習能力較弱的學生，經原修了三次才通過，最終以經原PR99通過該課程，我們有很高的機率相信：該學生的個經PR表現也不會太差。因其修了三次經原，經濟實力應可顯著提升。
  所以，若只考慮門檻（可不可修個經），可能會造成偏誤。\
  換一個角度想，若有一名天資聰穎、學習能力佳的學生，於經原課程混水摸魚或較不上心，但仍以經原60分通過該課程，我們也會有很高的機率相信：該學生的個經PR表現也不會太好。\
